...
// Source: github.com/tq-systems/public-go-utils/device (interfaces: Info)
//
// Generated by this command:
//
//	mockgen --build_flags=--mod=mod -destination=../mocks/device/mock_device.go -package=device github.com/tq-systems/public-go-utils/device Info
//
