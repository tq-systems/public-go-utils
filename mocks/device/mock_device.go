...
//
//	mockgen --build_flags=--mod=mod -source=device.go -destination=../mocks/device/mock_device.go -package=device Info
//
...
import (
	...
	device "github.com/tq-systems/public-go-utils/v3/device"
...
func (m *MockInfo) GetHwType() string {
	m.ctrl.T.Helper()
...
func (mr *MockInfoMockRecorder) GetHwType() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetHwType", reflect.TypeOf((*MockInfo)(nil).GetHwType))
}
...
// GetRaucCompatible mocks base method.
func (m *MockInfo) GetRaucCompatible() (device.RaucCompatibleInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRaucCompatible")
	ret0, _ := ret[0].(device.RaucCompatibleInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetRaucCompatible indicates an expected call of GetRaucCompatible.
func (mr *MockInfoMockRecorder) GetRaucCompatible() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRaucCompatible", reflect.TypeOf((*MockInfo)(nil).GetRaucCompatible))
}
