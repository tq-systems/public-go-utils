...
//go:generate mockgen --build_flags=--mod=mod -destination=../mocks/status/mock_status.go -package=status github.com/tq-systems/public-go-utils/v2/status Handler
